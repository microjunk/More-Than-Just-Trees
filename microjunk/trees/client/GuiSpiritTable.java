...
import microjunk.trees.common.furnaces.ContainerSpiritTable;
...
public class GuiSpiritTable extends GuiContainer
{
    ...
    private ContainerSpiritTable containerSpiritTable;
    ...
    public GuiSpiritTable(InventoryPlayer inventory, World world, int par3, int par4, int par5)
    {
        ...
        this.containerSpiritTable = (ContainerSpiritTable)this.inventorySlots;
    }
    ...
    protected void mouseClicked(int par1, int par2, int par3)
    {
        ...
        for (int var6 = 0; var6 < 3; ++var6)
        {
            ...
            if (var7 >= 0 && var8 >= 0 && var7 < 108 && var8 < 19 && this.containerSpiritTable.enchantItem(this.mc.thePlayer, var6))
            {
                this.mc.playerController.sendEnchantPacket(this.containerSpiritTable.windowId, var6);
            }
        }
    }
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/microjunk/trees/common/aart/enchant.png");
        ...
        this.mc.renderEngine.bindTexture(this.mc.renderEngine.getTexture("/microjunk/trees/common/aart/book.png"));
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        this.mc.renderEngine.bindTexture(var4);
        EnchantmentNameParts.instance.setRandSeed(this.containerSpiritTable.nameSeed);
        ...
        for (int var13 = 0; var13 < 3; ++var13)
        {
            ...
            this.zLevel = 0.0F;
            this.mc.renderEngine.bindTexture(var4);
            int var15 = this.containerSpiritTable.enchantLevels[var13];
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    public void func_74205_h()
    {
        ...
        {
            if (this.containerSpiritTable.enchantLevels[var3] != 0)
            {
                var2 = true;
            }
        }
