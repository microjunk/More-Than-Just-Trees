...
import microjunk.trees.common.furnaces.ContainerTreeTrunk;
import net.minecraft.client.gui.inventory.GuiContainer;
import net.minecraft.inventory.IInventory;
import net.minecraft.util.StatCollector;

public class GuiTreeTrunk extends GuiContainer
{
    ...
    public GuiTreeTrunk(IInventory par1IInventory, IInventory par2IInventory)
    {
        super(new ContainerTreeTrunk(par1IInventory, par2IInventory));
