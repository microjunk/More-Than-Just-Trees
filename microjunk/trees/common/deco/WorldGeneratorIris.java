...
public class WorldGeneratorIris implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAlphaHills) || (biome instanceof BiomeCliffs) || (biome instanceof BiomeEggHills) || (biome instanceof BiomeFruitValley) || (biome instanceof BiomeSkysPeak) || (biome instanceof BiomeThickForest) || (biome instanceof BiomeWhitePlains))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.iris.blockID);
                }
	        }
		}
