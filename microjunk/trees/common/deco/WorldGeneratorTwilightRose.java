...
public class WorldGeneratorTwilightRose implements IWorldGenerator 
{
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAlphaHills) || (biome instanceof BiomeCliffs) || (biome instanceof BiomeColdValley) || (biome instanceof BiomeFruitValley) || (biome instanceof BiomeSkysPeak) || (biome instanceof BiomeWhitePlains) || (biome instanceof BiomeWolf))
		{
			for(int x = 0;x<2;x++)
	        {
