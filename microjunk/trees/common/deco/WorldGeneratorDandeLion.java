...
public class WorldGeneratorDandeLion implements IWorldGenerator 
{
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAlphaHills) || (biome instanceof BiomeAfterLifeDesert) || (biome instanceof BiomeBlackMountains) || (biome instanceof BiomeCliffs) || (biome instanceof BiomeColdValley) || (biome instanceof BiomeEggHills) || (biome instanceof BiomeFruitValley) || (biome instanceof BiomeHardMountains) || (biome instanceof BiomeHurtfulHills) || (biome instanceof BiomeLegendaryForest) || (biome instanceof BiomePetrifiedHills) || (biome instanceof BiomeRainForrest) || (biome instanceof BiomeRedwoodForrest) || (biome instanceof BiomeSkysPeak) || (biome instanceof BiomeStoneMountains) || (biome instanceof BiomeTheOrient) || (biome instanceof BiomeThickForest) || (biome instanceof BiomeUnNaturalPlains) || (biome instanceof BiomeWhitePlains) || (biome instanceof BiomeWitheringHeights) || (biome instanceof BiomeWolf) || (biome instanceof BiomeZeroValley))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.dandelion.blockID);
                }
	        }
		}
