...
public class WorldGeneratorWhiteCactus implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAfterLifeDesert) || (biome instanceof BiomeCliffs) || (biome instanceof BiomeColdValley) || (biome instanceof BiomeTheOrient) || (biome instanceof BiomeWhitePlains))
		{
			for(int x = 0;x<2;x++)
	        {
