...
public class WorldGeneratorHosta implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAlphaHills) || (biome instanceof BiomeCliffs) || (biome instanceof BiomeEggHills) || (biome instanceof BiomeFruitValley) || (biome instanceof BiomeLegendaryForest) || (biome instanceof BiomeRainForrest) || (biome instanceof BiomeRedwoodForrest) || (biome instanceof BiomeSkysPeak) || (biome instanceof BiomeTheOrient) || (biome instanceof BiomeThickForest) || (biome instanceof BiomeWhitePlains) || (biome instanceof BiomeWitheringHeights) || (biome instanceof BiomeWolf))
		{
			for(int x = 0;x<2;x++)
	        {
