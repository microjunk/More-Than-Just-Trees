...
public class WorldGeneratorWildOnion implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAlphaHills) || (biome instanceof BiomeCliffs) || (biome instanceof BiomeWolf))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.wildOnion.blockID);
                }
	        }
		}
