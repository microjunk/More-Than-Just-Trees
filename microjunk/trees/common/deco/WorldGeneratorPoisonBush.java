...
public class WorldGeneratorPoisonBush implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAfterLifeDesert) || (biome instanceof BiomeBlackMountains) || (biome instanceof BiomeHardMountains) || (biome instanceof BiomeHurtfulHills) || (biome instanceof BiomeLegendaryForest) || (biome instanceof BiomePetrifiedHills) || (biome instanceof BiomeThickForest) || (biome instanceof BiomeUnNaturalPlains) || (biome instanceof BiomeWitheringHeights) || (biome instanceof BiomeZeroValley))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.poisonbush.blockID);
                }
	        }
		}
