...
public class WorldGeneratorSwell implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAfterLifeDesert) || (biome instanceof BiomeZeroValley) || (biome instanceof BiomeGenDesert))
		{
			for(int x = 0;x<2;x++)
	        {
