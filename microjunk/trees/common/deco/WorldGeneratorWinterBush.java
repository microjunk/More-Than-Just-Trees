...
public class WorldGeneratorWinterBush implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeGenTaiga) || (biome instanceof BiomeColdValley) || (biome instanceof BiomeZeroValley) || (biome instanceof BiomeGenSnow))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.winterbush.blockID);
                }
	        }
		}
