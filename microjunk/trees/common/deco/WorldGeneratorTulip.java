...
public class WorldGeneratorTulip implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAlphaHills) || (biome instanceof BiomeCliffs) || (biome instanceof BiomeFruitValley) || (biome instanceof BiomeSkysPeak) || (biome instanceof BiomeTheOrient) || (biome instanceof BiomeWhitePlains) || (biome instanceof BiomeWitheringHeights) || (biome instanceof BiomeWolf))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.tulip.blockID);
                }
	        }
		}
