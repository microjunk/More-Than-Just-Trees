...
public class WorldGeneratorEleGrass implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeCliffs) || (biome instanceof BiomeLegendaryForest) || (biome instanceof BiomeRedwoodForrest) || (biome instanceof BiomeThickForest) || (biome instanceof BiomeUnNaturalPlains) || (biome instanceof BiomeWhitePlains) || (biome instanceof BiomeWitheringHeights) || (biome instanceof BiomeWolf))
		{
			for(int x = 0;x<2;x++)
	        {
	        	...
	        	if (world.getBlockId(i, j - 1, k) == Block.dirt.blockID || world.getBlockId(i, j - 1, k) == Block.grass.blockID || world.getBlockId(i, j - 1, k) == Trees.alphaGrass.blockID)
                {
                    world.setBlockWithNotify(i, j, k, Trees.eleGrass.blockID);
                }
	        }
		}
