...
public class WorldGeneratorArrowCactus implements IWorldGenerator 
{
	@Override
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAfterLifeDesert) || (biome instanceof BiomeBlackMountains) || (biome instanceof BiomeColdValley) || (biome instanceof BiomeHurtfulHills) || (biome instanceof BiomeThickForest))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.spikebush.blockID);
                }
	        }
		}
