...
public class WorldGeneratorBush implements IWorldGenerator 
{
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAfterLifeDesert) || (biome instanceof BiomeBlackMountains) || (biome instanceof BiomeHardMountains) || (biome instanceof BiomeLegendaryForest) || (biome instanceof BiomePetrifiedHills) || (biome instanceof BiomeStoneMountains))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.bush.blockID);
                }
	        }
		}
