...
public class WorldGeneratorFlameCactus implements IWorldGenerator 
{
	...
	private void generateSurface(World world, Random random, int blockX, int blockZ) 
    {
		...
		if((biome instanceof BiomeAfterLifeDesert) || (biome instanceof BiomeHurtfulHills) || (biome instanceof BiomePetrifiedHills) || (biome instanceof BiomeTheOrient) || (biome instanceof BiomeUnNaturalPlains) || (biome instanceof BiomeZeroValley))
		{
			for(int x = 0;x<2;x++)
	        {
                ...
                {
                    world.setBlockWithNotify(i, j, k, Trees.flameCactus.blockID);
                }
	        }
		}
