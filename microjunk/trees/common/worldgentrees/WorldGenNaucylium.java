...
public class WorldGenNaucylium extends WorldGenerator
{
    private int minableBlockId;
    private int numberOfBlocks;

    public WorldGenNaucylium(int var1, int var2)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && var1.getBlockId(var38, var41, var44) == Trees.naucylium.blockID)
                                {
