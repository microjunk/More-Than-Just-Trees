...
public class EntityAttackPig extends EntityTameable
{
    ...
    public EntityAttackPig(World par1World)
    {
        super(par1World);
        this.texture = "/microjunk/trees/common/aart/angrypig.png";
        ...
        this.tasks.addTask(8, new EntityAIPigBeg(this, 8.0F));
    ...
    {
        return this.isTamed() ? "/microjunk/trees/common/aart/angrypig.png" : (this.isAngry() ? "/microjunk/trees/common/aart/angrypig.png" : super.getTexture());
    }
     ...
     */
    public EntityAttackPig spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityAttackPig var2 = new EntityAttackPig(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityAttackPig))
        {
            return false;
        }
        else
        {
            EntityAttackPig var2 = (EntityAttackPig)par1EntityAnimal;
