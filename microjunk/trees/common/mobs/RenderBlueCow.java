...
public class RenderBlueCow extends RenderLiving
{
    public RenderBlueCow(ModelBase par1ModelBase, float par2)
    {
        super(par1ModelBase, par2);
    }

    public void renderBlueCow(EntityBlueCow par1EntityBlueCow, double par2, double par4, double par6, float par8, float par9)
    {
