...
public class BlockTreeTrunk extends BlockContainer
{
    private static final ForgeDirection DOWN = null;
	private Random random = new Random();

    public BlockTreeTrunk(int par1, int par2)
    {
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityTreeTrunk var6 = (TileEntityTreeTrunk)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        TileEntityTreeTrunk var7 = (TileEntityTreeTrunk)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object var10 = (TileEntityTreeTrunk)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (TileEntityTreeTrunk)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)var10);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (IInventory)var10, (TileEntityTreeTrunk)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (TileEntityTreeTrunk)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)var10);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                var10 = new InventoryLargeChest("container.chestDouble", (IInventory)var10, (TileEntityTreeTrunk)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
		...
		{
			TileEntityTreeTrunk var101 = (TileEntityTreeTrunk) par1World.getBlockTileEntity(par2, par3, par4);
			if (var101 != null) 
			{
				par5EntityPlayer.openGui(Trees.instance, 3, par1World, par2, par3, par4);
			}
			return true;
		} 
		else 
    ...
    {
        return new TileEntityTreeTrunk();
    }
