...
import microjunk.trees.common.travel.ModelLavaBoat;
...
public class TileEntityTreeTrunk extends TileEntity implements IInventory
{
    private ItemStack[] chestContents = new ItemStack[36];
    public boolean adjacentChestChecked = false;
    public TileEntityTreeTrunk adjacentChestZNeg;
    public TileEntityTreeTrunk adjacentChestXPos;
    public TileEntityTreeTrunk adjacentChestXNeg;
    public TileEntityTreeTrunk adjacentChestZPosition;
    ...
    private void func_90009_a(TileEntityTreeTrunk par1TileEntityTreeTrunk, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            if (this.worldObj.getBlockId(this.xCoord - 1, this.yCoord, this.zCoord) == Trees.treeTrunk.blockID)
            {
                this.adjacentChestXNeg = (TileEntityTreeTrunk)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.worldObj.getBlockId(this.xCoord + 1, this.yCoord, this.zCoord) == Trees.treeTrunk.blockID)
            {
                this.adjacentChestXPos = (TileEntityTreeTrunk)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord - 1) == Trees.treeTrunk.blockID)
            {
                this.adjacentChestZNeg = (TileEntityTreeTrunk)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord + 1) == Trees.treeTrunk.blockID)
            {
                this.adjacentChestZPosition = (TileEntityTreeTrunk)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote && this.numUsingPlayers != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0)
        {
            ...
            while (var3.hasNext())
            {
                ...
                if (var4.openContainer instanceof ContainerTreeTrunk)
                {
                    IInventory var5 = ((ContainerTreeTrunk)var4.openContainer).getLowerChestInventory();
    ...
    {
        ++this.numUsingPlayers;
        this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, Trees.treeTrunk.blockID, 1, this.numUsingPlayers);
    }
