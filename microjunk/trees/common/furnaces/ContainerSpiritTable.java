...
{  
        ...
        public IInventory tableInventory = new SlotSpiritTable(this, "Spirit Table", 1);  
        //private TileEntityCustomEnchantmentTable ctenchant;  
        ...
        public ContainerSpiritTable(InventoryPlayer inventory, World par2World, int par3, int par4, int par5)  
        {  
                this.worldPointer = par2World;  
                this.posX = par3;  
                this.posY = par4;  
                this.posZ = par5;  
                this.addSlotToContainer(new SlotSpirit(this, this.tableInventory, 0, 25, 47));  
                int var6;  
        ...
        public ContainerSpiritTable(InventoryPlayer inventory, TileEntitySpiritTable tile_entity)  
        {  
...
public void addCraftingToCrafters(ICrafting par1ICrafting)  
        ...
        {  
                return this.worldPointer.getBlockId(this.posX, this.posY, this.posZ) != Trees.spiritTable.blockID ? false : par1EntityPlayer.getDistanceSq(posX + 0.5D, posY + 0.5D, posZ + 0.5D) <= 64.0D;  
        }  
        /**  
