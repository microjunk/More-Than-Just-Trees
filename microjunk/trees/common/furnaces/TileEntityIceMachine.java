...
public class TileEntityIceMachine extends TileEntity implements IInventory, ISidedInventory
{
    /**
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                var2 = true;
                BlockIceMachine.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack var1 = IceMachineRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
