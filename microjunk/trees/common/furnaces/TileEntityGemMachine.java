...
public class TileEntityGemMachine extends TileEntity implements IInventory, ISidedInventory
{
    /**
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                var2 = true;
                BlockGemMachine.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack var1 = GemMachineRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
