...
public class ContainerForge extends Container
{
     ...
     */
    private IInventory inputSlots = new InventoryForge(this, "Repair", 2);
    ...
    public ContainerForge(InventoryPlayer par1InventoryPlayer, World world, int par3, int par4, int par5, EntityPlayer par6EntityPlayer)
    {
        this.theWorld = world;
        ...
        this.addSlotToContainer(new SlotForge(this, this.outputSlot, 2, 134, 47, world, par3, par4, par5));
        int var7;
    ...
    {
        return this.theWorld.getBlockId(this.field_82861_i, this.field_82858_j, this.field_82859_k) != Trees.forge.blockID ? false : par1EntityPlayer.getDistanceSq((double)this.field_82861_i + 0.5D, (double)this.field_82858_j + 0.5D, (double)this.field_82859_k + 0.5D) <= 64.0D;
    }
    ...
    static IInventory getRepairInputInventory(ContainerForge par0ContainerForge)
    {
        return par0ContainerForge.inputSlots;
    }

    static int getStackSizeUsedInRepair(ContainerForge par0ContainerForge)
    {
        return par0ContainerForge.stackSizeToBeUsedInRepair;
    }
}
