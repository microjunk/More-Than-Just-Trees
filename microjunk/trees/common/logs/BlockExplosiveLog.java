...
public class BlockExplosiveLog extends Block
{
    ...
    {
        return Trees.explosiveLog.blockID;
    }
    ...
    public int getBlockTextureFromSideAndMetadata(int par1, int par2)
    {
        int var3 = par2 & 12;
        int var4 = par2 & 3;
        return var3 == 0 && (par1 == 1 || par1 == 0) ? 117 : (var3 == 4 && (par1 == 5 || par1 == 4) ? 117 : (var3 == 8 && (par1 == 2 || par1 == 3) ? 117 : (var4 == 1 ? 24 : (var4 == 2 ? 25 : (var4 == 3 ? 26 : 101)))));
    }
    ...
    /*public void onBlockDestroyedByPlayer(World world, int i, int j, int k, int l)
    {
    	if (!world.isRemote)
    	{
    		EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(world, 0.0D, 0.0D, 0.0D);
            entitytntprimed.setLocationAndAngles(i, j, k, 0.0F, 0.0F);
