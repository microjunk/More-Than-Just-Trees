...
public class BlockWolfLog extends Block
{
    public BlockWolfLog(int par1)
    {
    ...
    {
        return Trees.wolfLog.blockID;
    }

    // this essentially helps leaves to decay when they are not conected to wood. 
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int 
...
par6)
    {
        ...
        if (par1World.checkChunksExist(par2 - var8, par3 - var8, par4 - var8, par2 + 

var8, par3 + var8, par4 + var8))
        {
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    ...
                    {
                        int var12 = par1World.getBlockId(par2 + var9, par3 + var10, 

par4 + var11);

                        if (Block.blocksList[var12] != null)
                        {
                            Block.blocksList[var12].beginLeavesDecay(par1World, par2 + 

var9, par3 + var10, par4 + var11);
                        }
                    }
                }
            }
    ...
    public void updateBlockMetadata(World par1World, int par2, int par3, int par4, int 
...
par5, float par6, float par7, float par8)
    ...
    public int getBlockTextureFromSideAndMetadata(int par1, int par2)
    {
        int var3 = par2 & 12;
        int var4 = par2 & 3;
        return var3 == 0 && (par1 == 1 || par1 == 0) ? 51 : (var3 == 4 && (par1 == 5 || par1 == 4) ? 51 : (var3 == 8 && (par1 == 2 || par1 == 3) ? 51 : (var4 == 1 ? 24 : (var4 == 2 ? 25 : (var4 == 3 ? 26 : 35)))));
    }
