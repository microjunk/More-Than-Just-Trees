...
public class BlockLifeLog extends Block
{
    public BlockLifeLog(int par1)
    {
    ...
    public int getBlockTextureFromSideAndMetadata(int par1, int par2)
    {
        int var3 = par2 & 12;
        int var4 = par2 & 3;
        return var3 == 0 && (par1 == 1 || par1 == 0) ? 113 : (var3 == 4 && (par1 == 5 || par1 == 4) ? 113 : (var3 == 8 && (par1 == 2 || par1 == 3) ? 113 : (var4 == 1 ? 24 : (var4 == 2 ? 25 : (var4 == 3 ? 26 : 97)))));
    }
    ...
    {
    	ModLoader.getMinecraftInstance().thePlayer.addPotionEffect(new PotionEffect(Potion.regeneration.id, 100,2));
    }
