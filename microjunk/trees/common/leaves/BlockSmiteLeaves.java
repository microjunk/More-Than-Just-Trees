...
public class BlockSmiteLeaves extends BlockLeavesBase implements IShearable
{

    int[] adjacentTreeBlocks;

    public BlockSmiteLeaves(int par1, int par2)
    {
   ...
   // this code deals with the drop rates
    ...
    {
            return Trees.smiteSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(Trees.iceSapling, 1, 0));
            }
        }
    }
    ...
    public void onBlockDestroyedByPlayer(World world, int i, int j, int k, int l)
    {
    	if (!world.isRemote)
    	{
            ...
            entitylightningbolt.setLocationAndAngles(i, j, k, 0.0F, 0.0F);
