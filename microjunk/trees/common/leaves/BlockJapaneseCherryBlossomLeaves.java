...
public class BlockJapaneseCherryBlossomLeaves extends BlockLeavesBase implements IShearable
{

    int[] adjacentTreeBlocks;

    public BlockJapaneseCherryBlossomLeaves(int par1, int par2)
    {
   ...
   // this code deals with the drop rates
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(Trees.blackSapling, 1, 0));
            }
        }
    }
