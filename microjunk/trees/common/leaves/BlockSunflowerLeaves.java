...
public class BlockSunflowerLeaves extends BlockLeavesBase implements IShearable
{

    int[] adjacentTreeBlocks;

    public BlockSunflowerLeaves(int par1, int par2)
    {
  ...
  //this code is related to leaf decay. you shouldnt need to change it.
   ...
   // this code deals with the drop rates
    ...
    public int idDropped(int par1, Random par2Random, int par3)
    {
        ...
        return Trees.sunflowerSapling.blockID;
        return Trees.sunflowerSeeds.itemID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(Trees.sunflowerSeeds, 1, 0));
            }
        }
    }
