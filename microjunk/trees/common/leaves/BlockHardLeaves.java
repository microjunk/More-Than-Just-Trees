...
public class BlockHardLeaves extends BlockLeavesBase implements IShearable
{

    int[] adjacentTreeBlocks;

    public BlockHardLeaves(int par1, int par2)
    {
   ...
   // this code deals with the drop rates
    ...
    public int idDropped(int par1, Random par2Random, int par3)
    {
    	if(par2Random.nextInt(5) == 0)
            return Trees.hardSapling.blockID;
            return Trees.diamondDust.itemID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(Trees.hardSapling, 1, 0));
            }
        }
    }
