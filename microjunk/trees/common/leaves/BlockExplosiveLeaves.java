...
public class BlockExplosiveLeaves extends BlockLeavesBase implements IShearable
{

    int[] adjacentTreeBlocks;

    public BlockExplosiveLeaves(int par1, int par2)
    {
   ...
   // this code deals with the drop rates
    ...
    {
    	return Trees.explosiveSapling.blockID;
    }
