...
public class BlockWaterLeaves extends BlockLeavesBase implements IShearable
{

    int[] adjacentTreeBlocks;

    public BlockWaterLeaves(int par1, int par2)
    {
    ...
    {
    	world.spawnParticle("dripWater", i+0.5, j+0.0, k+0.5, 0.0D, 0.0D, 0.0D);	
    	world.spawnParticle("splash", i+0.5, j+1.0, k+0.5, 0.0D, 0.0D, 0.0D);
    }
  ...
  //this code is related to leaf decay. you shouldnt need to change it.
   ...
   // this code deals with the drop rates
    ...
    {
        return Trees.waterSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(Trees.waterSapling, 1, 0));
            }
        }
    }
