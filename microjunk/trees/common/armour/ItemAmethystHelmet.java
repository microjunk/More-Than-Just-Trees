...
public class ItemAmethystHelmet extends ItemArmor implements IArmorTextureProvider
{

	public ItemAmethystHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
