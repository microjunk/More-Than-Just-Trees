...
public class ItemSapphireBoots extends ItemArmor implements IArmorTextureProvider
{
 
	public ItemSapphireBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
