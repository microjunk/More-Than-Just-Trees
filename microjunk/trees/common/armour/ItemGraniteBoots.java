...
public class ItemGraniteBoots extends ItemArmor implements IArmorTextureProvider
{
 
	public ItemGraniteBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
