...
public class ItemStonewoodLegs extends ItemArmor implements IArmorTextureProvider
{

	public ItemStonewoodLegs(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
	{
