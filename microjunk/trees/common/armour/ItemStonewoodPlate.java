...
public class ItemStonewoodPlate extends ItemArmor implements IArmorTextureProvider
{

	public ItemStonewoodPlate(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
	{
