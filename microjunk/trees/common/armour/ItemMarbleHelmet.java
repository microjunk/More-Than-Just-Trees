...
public class ItemMarbleHelmet extends ItemArmor implements IArmorTextureProvider
{

	public ItemMarbleHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
