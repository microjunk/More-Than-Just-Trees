...
public class ItemMarbleBoots extends ItemArmor implements IArmorTextureProvider
{
 
	public ItemMarbleBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
