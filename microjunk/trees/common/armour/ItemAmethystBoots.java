...
public class ItemAmethystBoots extends ItemArmor implements IArmorTextureProvider
{
 
	public ItemAmethystBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
