...
public class ItemStonewoodBoots extends ItemArmor implements IArmorTextureProvider
{
 
	public ItemStonewoodBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
