...
public class ItemGraniteHelmet extends ItemArmor implements IArmorTextureProvider
{

	public ItemGraniteHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
