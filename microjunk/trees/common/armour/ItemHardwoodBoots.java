...
public class ItemHardwoodBoots extends ItemArmor implements IArmorTextureProvider
{
 
	public ItemHardwoodBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
