...
public class ItemMarbleLegs extends ItemArmor implements IArmorTextureProvider
{

	public ItemMarbleLegs(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) 
	{
