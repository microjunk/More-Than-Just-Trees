...
public class WorldGeneratorIceTrees implements IWorldGenerator 
{
 ...
 private void generateSurface(World world, Random rand, int chunkX, int chunkZ) 
 {
	 ...
	 WorldGenIceTrees tree = new WorldGenIceTrees(false);
	 
	 if((biome instanceof BiomeColdValley))// then add ||BiomeGenXYZ if you want more.
	 {
        for(int x = 0;x<2;x++)
        {
