...
public class WorldGeneratorStoneTrees implements IWorldGenerator 
{
 ...
 private void generateSurface(World world, Random rand, int chunkX, int chunkZ) 
 {
	...
	WorldGenStoneTrees tree = new WorldGenStoneTrees(false);
	if((biome instanceof BiomePetrifiedHills))// then add ||BiomeGenXYZ if you want more.
	{
        for(int x = 0;x<2;x++)
        {
	...
	if((biome instanceof BiomeAfterLifeDesert))// then add ||BiomeGenXYZ if you want more.
	{
        for(int x = 0;x<2;x++)
        {
