...
import microjunk.trees.common.worldgentrees.WorldGenSoftTrees;
import net.minecraft.world.World;
import net.minecraft.world.biome.BiomeGenBase;
import net.minecraft.world.chunk.IChunkProvider;
import cpw.mods.fml.common.IWorldGenerator;

public class WorldGeneratorSoftTrees implements IWorldGenerator 
{
 ...
 private void generateSurface(World world, Random rand, int chunkX, int chunkZ) 
 {
	...
	WorldGenSoftTrees tree = new WorldGenSoftTrees(false);
	if((biome instanceof BiomeWhitePlains))// then add ||BiomeGenXYZ if you want more.
	{
        for(int x = 0;x<2;x++)
        {
