...
public class WorldGeneratorSmokinTrees implements IWorldGenerator 
{
 ...
 private void generateSurface(World world, Random rand, int chunkX, int chunkZ) 
 {
	...
	WorldGenSmokinTrees tree = new WorldGenSmokinTrees(false);
	
	if((biome instanceof BiomeGenMushroomIsland))// then add ||BiomeGenXYZ if you want more.
	{
        for(int x = 0;x<2;x++)
        {
