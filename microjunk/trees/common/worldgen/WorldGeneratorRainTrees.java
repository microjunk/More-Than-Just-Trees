...
import microjunk.trees.common.worldgentrees.WorldGenRainTrees;
...
public class WorldGeneratorRainTrees implements IWorldGenerator 
{
 ...
 private void generateSurface(World world, Random rand, int chunkX, int chunkZ) 
 {
	 ...
	 WorldGenRainTrees tree = new WorldGenRainTrees(false);
	 
	 if((biome instanceof BiomeRainForrest))// then add ||BiomeGenXYZ if you want more.
	 {
        for(int x = 0;x<2;x++)
        {
