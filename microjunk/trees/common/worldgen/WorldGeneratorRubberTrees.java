...
import microjunk.trees.common.worldgentrees.WorldGenRubberTrees;
...
public class WorldGeneratorRubberTrees implements IWorldGenerator 
{
 ...
 private void generateSurface(World world, Random rand, int chunkX, int chunkZ) 
 {
	 ...
	 WorldGenRubberTrees tree = new WorldGenRubberTrees(false);
	 
	 if((biome instanceof BiomeGenJungle))// then add ||BiomeGenXYZ if you want more.
	 {
		 for(int x = 0;x<2;x++)
		 {
