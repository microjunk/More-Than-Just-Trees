...
public class EntityExplosiveArrow extends Entity
{
    ...
    public EntityExplosiveArrow(World var1, EntityLiving var2, EntityLiving var3, float var4, float var5)
    {
        super(var1);
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            {
                ++this.ticksInGround;
                this.worldObj.createExplosion((Entity)null, (double)this.xTile, (double)this.yTile, (double)this.zTile, 2.5F, inGround);
                this.setDead();
            }
            else
            {
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var21 = causeExplodingArrowDamage(this, this);
                    }
                    else
                    {
                        var21 = causeExplodingArrowDamage(this, this.shootingEntity);
                    }
                    ...
                    if (var4.entityHit.attackEntityFrom(var21, var23))
                    {
                        if (var4.entityHit instanceof EntityLiving)
                        {
                            ...
                            this.worldObj.createExplosion((Entity)null, this.posX, this.posY, this.posZ, 2.5F, arrowCritical);
                            this.setDead();
            ...
            this.setPosition(this.posX, this.posY, this.posZ);
            this.worldObj.spawnParticle("largesmoke", this.posX, this.posY, this.posZ, -this.motionX * 0.1D, -this.motionY * 0.1D, -this.motionZ * 0.1D);
        }
    }
    ...
    public static DamageSource causeExplodingArrowDamage(EntityExplosiveArrow var0, Entity var1)
    {
