...
public class EntityLightningArrow extends Entity 
{
    //public net.minecraft.src.EntityArrow entityarrow;
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityLightningArrow(World var1)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    }

    public EntityLightningArrow(World var1, double var2, double var4, double var6)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityLightningArrow(World var1, EntityLiving var2, EntityLiving var3, float var4, float var5)
    {
        super(var1);
    ...
    public EntityLightningArrow(World var1, EntityLiving var2, float var3)
    {
        super(var1);
        this.shootingEntity = var2;
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            {
                ++this.ticksInGround;
                this.worldObj.addWeatherEffect(new EntityLightningBolt(this.worldObj, (double)this.xTile, (double)this.yTile, (double)this.zTile));
                this.worldObj.setBlockWithNotify(this.xTile, this.yTile + 1, this.zTile, Block.fire.blockID);
                this.setDead();
            }
            else
            {
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var22 = Trees.causeLightningArrowDamage(this, this);
                    }
                    else
                    {
                        var22 = Trees.causeLightningArrowDamage(this, this.shootingEntity);
                    }

                    this.worldObj.addWeatherEffect(new EntityLightningBolt(this.worldObj, var4.entityHit.prevPosX, var4.entityHit.prevPosY, var4.entityHit.prevPosZ));
                    ...
                    if (var4.entityHit.attackEntityFrom(var22, var21))
                    {
                        if (var4.entityHit instanceof EntityLiving)
                        {
                            ...
                            if (this.knockbackStrength > 0)
                            {
                                ...
                                if (var24 > 0.0F)
                                {
                                    var4.entityHit.addVelocity(this.motionX * (double)this.knockbackStrength * 0.6000000238418579D / (double)var24, 0.1D, this.motionZ * (double)this.knockbackStrength * 0.6000000238418579D / (double)var24);
                                }
                            }
                        }
    ...
    public void onCollideWithPlayer(EntityPlayer var1)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !var1.inventory.addItemStackToInventory(new ItemStack(Trees.lightningArrow, 1)))
            {
                var2 = false;
            }
