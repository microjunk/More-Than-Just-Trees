...
public class EntityPurpleArrow extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityPurpleArrow(World var1)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    }

    public EntityPurpleArrow(World var1, double var2, double var4, double var6)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityPurpleArrow(World var1, EntityLiving var2, EntityLiving var3, float var4, float var5)
    {
        super(var1);
    ...
    public EntityPurpleArrow(World var1, EntityLiving var2, float var3)
    {
        super(var1);
        this.shootingEntity = var2;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var22 = Trees.causePurpleArrowDamage(this, this);
                    }
                    else
                    {
                        var22 = Trees.causePurpleArrowDamage(this, this.shootingEntity);
                    }
