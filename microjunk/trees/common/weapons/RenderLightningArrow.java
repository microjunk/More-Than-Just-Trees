...
public class RenderLightningArrow extends Render
{
    ...
    {
        this.loadTexture("/microjunk/trees/common/aart/lightningarrow.png");
        GL11.glPushMatrix();
        ...
        GL11.glRotatef(par1EntityLightningArrow.prevRotationPitch + (par1EntityLightningArrow.rotationPitch - par1EntityLightningArrow.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
        ...
        float var21 = (float)par1EntityLightningArrow.arrowShake - par9;
