...
public class EntitySnowSled extends Entity
{
    ...
    public EntitySnowSled(World par1World)
    {
        super(par1World);
        this.field_70279_a = true;
        this.field_70276_b = 0.07D;
        this.preventEntitySpawning = true;
        this.texture = "/microjunk/trees/common/aart/snowsled.png";
    ...
    public EntitySnowSled(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (this.getDamageTaken() > 40)
            {
                ...
                this.dropItemWithOffset(Trees.snowSled.itemID, 1, 0.0F);
                this.setDead();
            }
    ...
    public void onUpdate()
    {
        ...
        for (int var4 = 0; var4 < var1; ++var4)
        {
            ...
            if (this.worldObj.isAABBInMaterial(var9, Material.snow))
            {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (var16 != null && !var16.isEmpty())
                {
                    for (var27 = 0; var27 < var16.size(); ++var27)
                    {
                        ...
                        if (var18 != this.riddenByEntity && var18.canBePushed() && var18 instanceof EntitySnowSled)
                        {
