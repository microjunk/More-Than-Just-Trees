...
public class EntityLavaBoat extends Entity
{
    ...
    public static boolean entityIsInBoat =  false;
    ...
    public EntityLavaBoat(World par1World)
    {
        ...
        this.texture = "/microjunk/trees/common/aart/lavaboat.png";
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (this.getDamageTaken() > 40)
            {
                ...
                this.dropItemWithOffset(Trees.lavaBoat.itemID, 1, 0.0F);
                this.setDead();
            }
    ...
    public void onUpdate()
    {
        ...
        for (int var4 = 0; var4 < var1; ++var4)
        {
            ...
            if (this.worldObj.isAABBInMaterial(var9, Material.lava))
            {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (var16 != null && !var16.isEmpty())
                {
                    for (var27 = 0; var27 < var16.size(); ++var27)
                    {
                        ...
                        if (var18 != this.riddenByEntity && var18.canBePushed() && var18 instanceof EntityLavaBoat)
                        {
                ...
                /*if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLiving) 
                {
                	...
                	System.out.println("Forcing health update...");
                }*/
                
                /*if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLiving) 
                {
                	//this.ridingEntity.extinguish();
                	Minecraft.getMinecraft().thePlayer.extinguish();
                	Minecraft.getMinecraft().thePlayer.setHealth(20);
                	System.out.println("Forcing health update...");
                }*/	
                ...
                if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLiving) 
                {
                	EntityLiving living = (EntityLiving) this.riddenByEntity;
                	living.addPotionEffect(new PotionEffect(Potion.fireResistance.id, 10, 0));
                ...
                {
                	EntityLiving living = (EntityLiving) this.riddenByEntity;
                	living.removePotionEffect(fireResistance);
                	this.dataWatcher.updateObject(0, Byte.valueOf((byte)(this.dataWatcher.getWatchableObjectByte(0) & ~(1 << 0))));
