...
public class EntityIceBoat extends Entity
{
    ...
    public EntityIceBoat(World par1World)
    {
        ...
        this.texture = "/microjunk/trees/common/aart/iceboat.png";
        this.setSize(1.5F, 0.6F);
        this.yOffset = this.height / 2.0F + 0.5F;
    }

	public ModelBase getModel()
        {
                return new ModelIceBoat();
        }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (this.getDamageTaken() > 40)
            {
                ...
                this.dropItemWithOffset(Trees.iceBoat.itemID, 1, 0.0F);
                this.setDead();
            }
    ...
    public void onUpdate()
    {
        ...
        for (int var4 = 0; var4 < var1; ++var4)
        {
            ...
            if (this.worldObj.isAABBInMaterial(var9, Material.ice))
            {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (var16 != null && !var16.isEmpty())
                {
                    for (var27 = 0; var27 < var16.size(); ++var27)
                    {
                        ...
                        if (var18 != this.riddenByEntity && var18.canBePushed() && var18 instanceof EntityIceBoat)
                        {
