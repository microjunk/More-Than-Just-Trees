...
public class ItemSnowSled extends Item
{
    public ItemSnowSled(int par1)
    {
        super(par1);
        this.maxStackSize = 1;
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if(movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            {
                par2World.spawnEntityInWorld(new EntitySnowSled(par2World, (float)i + 0.5F, (float)j + 1.5F, (float)k + 0.5F));
            }
