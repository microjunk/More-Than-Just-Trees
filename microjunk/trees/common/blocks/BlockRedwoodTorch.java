...
public class BlockRedwoodTorch extends Block
{
    public BlockRedwoodTorch(int par1, int par2)
    {
        super(par1, par2, Material.circuits); //this makes it a torch like block
        this.setTickRandomly(true);
        this.setCreativeTab(Trees.tabTreeBlocks); //this puts it in the decoration tabw
    }
