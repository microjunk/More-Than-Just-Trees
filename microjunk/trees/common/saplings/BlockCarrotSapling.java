...
import microjunk.trees.common.worldgentrees.WorldGenCarrotTree;
...
public class BlockCarrotSapling extends BlockFlower
{

        public BlockCarrotSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenCarrotTree();//Change to your own tree's gen class
