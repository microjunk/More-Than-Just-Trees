...
import microjunk.trees.common.worldgentrees.WorldGenGiantTrees;
...
public class BlockGiantSapling extends BlockFlower
{

        public BlockGiantSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenGiantTrees();//Change to your own tree's gen class
