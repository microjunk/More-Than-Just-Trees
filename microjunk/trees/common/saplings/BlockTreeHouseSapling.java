...
import microjunk.trees.common.worldgentrees.WorldGenTreeHouse;
...
public class BlockTreeHouseSapling extends BlockFlower
{

        public BlockTreeHouseSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenTreeHouse();//Change to your own tree's gen class
