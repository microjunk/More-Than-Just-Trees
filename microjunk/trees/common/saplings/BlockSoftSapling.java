...
public class BlockSoftSapling extends BlockFlower
{

        public BlockSoftSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenSoftTrees(false);//Change to your own tree's gen class
