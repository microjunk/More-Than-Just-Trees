...
import microjunk.trees.common.worldgentrees.WorldGenJMTree;
...
public class BlockjapaneseMapleSapling extends BlockFlower
{

        public BlockjapaneseMapleSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenJMTree();//Change to your own tree's gen class
