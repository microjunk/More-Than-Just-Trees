...
import microjunk.trees.common.worldgentrees.WorldGenCantaloupeTree;
...
public class BlockCantaloupeSapling extends BlockFlower
{

        public BlockCantaloupeSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenCantaloupeTree();//Change to your own tree's gen class
