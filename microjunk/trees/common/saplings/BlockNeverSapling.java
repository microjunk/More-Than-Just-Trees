...
import microjunk.trees.common.worldgentrees.WorldGenNeverTrees;
...
public class BlockNeverSapling extends BlockFlower
{

        public BlockNeverSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenNeverTrees(false);//Change to your own tree's gen class
