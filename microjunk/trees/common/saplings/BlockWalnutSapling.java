...
public class BlockWalnutSapling extends BlockFlower
{

        public BlockWalnutSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void updateTick(World world, int i, int j, int k, Random random)
        {
                ...
                if(world.getBlockLightValue(i, j + 1, k) >= 9 && random.nextInt(7) == 
...
0)
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenWalnutTrees(false);//Change to your own tree's gen class
...
entityplayer, int par2, float par3, float par4, float par5)
        {
           ...
           if ((equipped.getItem() == Item.dyePowder) && (equipped.getItemDamage() == 
