...
import microjunk.trees.common.worldgentrees.WorldGenSunflowerTrees;
...
public class BlockSunflowerSapling extends BlockFlower
{

        public BlockSunflowerSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenSunflowerTrees(false);//Change to your own tree's gen class
