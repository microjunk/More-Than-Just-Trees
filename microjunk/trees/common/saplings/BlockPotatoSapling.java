...
import microjunk.trees.common.worldgentrees.WorldGenPotatoTree;
...
public class BlockPotatoSapling extends BlockFlower
{

        public BlockPotatoSapling(int i, int j)
        {
                super(i, j);
                float f = 0.4F;
        ...
        public void growTree(World world, int i, int j, int k, Random random)
        {
                ...
                Object obj = null;
                obj = new WorldGenPotatoTree();//Change to your own tree's gen class
